...
input_file = f'/home/belle/zhangboy/Danny_HW/B2{decaymode}_N/MC/N_e_mass{M}_width{W}.root'
output_file = f'/home/belle/zhangboy/Danny_HW/B2{decaymode}_N/Ntuples/N_e_mass{M}_width{W}_2.root'
...
vx.treeFit('D+:K2pi', conf_level=0.00, updateAllDaughters=True, massConstraint=['D+'], ipConstraint=False, path=main_path)
...
# Reconstruct B
ma.reconstructDecay('B0:D3e -> D-:K2pi e+:corrected e-:corrected e+:corrected ?addbrems ?nu', cut='', path=main_path)
...
# Calculate DOCA(D,l)
ma.calculateDistance('B0:D3e', 'B0:D3e -> ^D-:K2pi ^e+:corrected e-:corrected e+:corrected', "vertextrack", path=main_path)
...
b_vars = vu.create_aliases_for_selected(
    ...
    decay_string='^B0:D3e -> D-:K2pi e+:corrected e-:corrected e+:corrected',
    prefix=['B0'])
...
ma.variablesToNtuple('anti-B0:D3e', candidate_vars,filename=output_file, treename='B0', path=main_path)
